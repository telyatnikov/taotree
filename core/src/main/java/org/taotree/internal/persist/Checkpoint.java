...
/**
 * Reads and writes checkpoint slots, replacing the v1 {@link Superblock} for the
...
public final class Checkpoint {
    ...
    public static final int SLOT_B_PAGE = 128;
    /** Number of pages per checkpoint slot (512 KB at 4 KB page size). */
    public static final int SLOT_SIZE_PAGES = 128;
    ...
    /**
     * v3 unified-temporal file format. Always set since the legacy
     * {@code LeafLayout}-based regular tree was removed; the only data model
     * is now an always-temporal tree. v2 files written without this bit
     * cannot be opened by the current code.
     */
    public static final long FEATURE_INCOMPAT_UNIFIED_TEMPORAL = 0x0004L;
    ...
    // SECTION_TEMPORAL_CONFIG (=6) was removed in v3 — temporal is the only model.
     ...
     * @param encoding       encoding format (currently always {@link #ENCODING_INLINE})
